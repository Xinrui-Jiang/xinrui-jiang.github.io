...
<div style="display: flex; justify-content: space-between; align-items: stretch; margin-top: 15px;">
<div style="flex-basis: 48%; text-align: center;">
<img src="{{ site.baseurl }}/images/fun_1.jpg" style="width: 100%; height: 250px; object-fit: cover; border-radius: 5px;">
</div>

<div style="flex-basis: 48%; text-align: center;">
<img src="{{ site.baseurl }}/images/my_dafu.jpg" style="width: 100%; height: 250px; object-fit: cover; border-radius: 5px;">
</div>
</div>
